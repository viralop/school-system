...
<head>
    ...
    <title>Forgot Password - ALWEFAQ</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="glass rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-blue-300/70 mt-1 text-sm">Reset Password</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-semibold py-2.5 rounded-xl transition shadow-lg shadow-blue-600/20">Send OTP</button>
        </form>

        <div class="text-center mt-6">
            <a href="{{ route('teacher.login') }}" class="text-blue-400/60 hover:text-blue-300 text-sm transition">Back to login</a>
        </div>
    </div>
</body>
</html>
