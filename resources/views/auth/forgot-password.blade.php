...
<head>
    ...
    <title>@lang('messages.Reset Password') - خولة بنت الأزور</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glass rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-[var(--text-muted)] mt-1 text-sm">@lang('messages.Reset Password')</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-semibold py-2.5 rounded-xl transition shadow-lg shadow-blue-600/20">@lang('messages.Send OTP')</button>
        </form>
        <div class="mt-4 flex items-center justify-between">
            <a href="{{ route('teacher.login') }}" class="text-[var(--text-secondary)] hover:text-[var(--text-primary)] text-sm transition">@lang('messages.Back to login')</a>
