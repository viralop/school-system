...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="glass rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-blue-300/70 mt-1 text-sm">Create Account</p>
        </div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('login') }}" class="text-blue-400 hover:text-blue-300 text-sm">Already have an account? Login</a>
        </div>
    </div>
</body>
</html>
