...
<head>
    ...
    <title>Teacher Login - ALWEFAQ</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="glass rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-blue-300/70 mt-1 text-sm">Teacher Login</p>
        </div>
        ...
        <div class="text-center mt-6 space-y-2">
            <a href="{{ route('password.request') }}" class="text-amber-400/60 hover:text-amber-300 text-sm block transition">Forgot Password?</a>
            <a href="{{ route('teacher.signup') }}" class="text-blue-400/60 hover:text-blue-300 text-sm transition">Don't have an account? Register</a>
        </div>
    </div>
</body>
</html>
