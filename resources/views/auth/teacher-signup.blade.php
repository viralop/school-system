...
<head>
    ...
    <title>@lang('messages.Teacher Registration') - ALWEFAQ</title>
    ...
    <div class="glass rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <form method="POST" action="{{ route('teacher.signup.step1') }}">
            ...
            <div class="mb-6">
                ...
                <p class="text-[var(--text-tertiary)] text-xs mt-2">@lang('messages.Only pre-approved emails can register.')</p>
            </div>
