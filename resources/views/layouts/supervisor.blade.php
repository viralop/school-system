...
<head>
    ...
    <style>
        ...
        .sidebar-panel:hover { box-shadow: 4px 0 24px -4px rgba(59, 130, 246, 0.08); }
...
<body class="min-h-screen system-theme">
    ...
    <div class="flex min-h-screen overflow-x-hidden">
        <aside class="sidebar-panel w-64 bg-[var(--bg-card)] border-{{ $isRtl ? 'l' : 'r' }} border-[var(--border-main)] flex flex-col fixed top-0 {{ $isRtl ? 'right-0' : 'left-0' }} h-full z-50 md:w-64 w-0 overflow-hidden" id="sidebar">
            <div class="p-5 border-b border-[var(--border-main)]">
                <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="logo-pulse rounded-xl p-0.5 bg-gradient-to-br from-blue-500/40 via-purple-500/30 to-pink-500/30">
                            ...
                            <span class="text-xs font-medium bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">{{ __('messages.Supervisor') }}</span>
                        </div>
                    </div>
            ...
            <nav class="sidebar-nav flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        <main class="flex-1 min-w-0 {{ $isRtl ? 'md:mr-64' : 'md:ml-64' }}">
            <header class="md:hidden sticky top-0 z-30 bg-[var(--bg-card)] border-b border-[var(--border-main)] px-4 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <div class="rounded-lg p-0.5 bg-gradient-to-br from-blue-500/30 via-purple-500/20 to-pink-500/20">
